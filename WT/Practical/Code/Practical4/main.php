<?php
    ...
    if(isset($_POST['btnCountVowel']))
    {
        $str = $_POST['vowelString'];
        echo "Original String: $str<br>";
        echo "No of Vowels is: ", vowelCount($str),"<br>";
    }
    if(isset($_POST['btnCompute']))
    {
        $startPos = $_POST['startPos'];
        $endPos = $_POST['endPos'];
        $skipPos = $_POST['skipNumber'];
        echo "Start Position: $startPos<br>";
        echo "End Position: $endPos<br>";
        echo "Skip Position: $skipPos<br>";
        echo "Result is: ",claculate($startPos,$endPos,$skipPos),"<br>";
    }
?>
<html>
    <body>
        <form method="post">
            <table>
                ...
                <tr>
                    <td>String : <input type="text" name="vowelString"/>
                    <input type="submit" name="btnCountVowel" value="Vowel Count" />
                    </td>
                </tr>
                <tr>
                    <td><hr></td>
                ...
                <tr>
                    <td>Start Position : <input type="text" name="startPos"/>
                    End Position : <input type="text" name="endPos"/>
                    Skip Position : <input type="text" name="skipNumber"/>
